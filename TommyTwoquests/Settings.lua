...
-- switches, sliders, dropdowns, search, live preview.
----------------------------------------------------------------------
local AddonName, TTQ = ...
    ...
    return {
        {
            ...
            options = {
                { type = "section", name = "Panel" },
                {
                    ...
                    get = function()
                        return
                            getDB("trackerWidth", 250)
                    end,
                    set = function(
                        v)
                        setDB("trackerWidth", v)
                    end
                },
                {
                    type = "slider",
                ...
                },
                {
                    ...
                    dbKey = "trackerMaxHeight",
                    min = 200,
                    max = 1200,
                    step = 25,
                    get = function()
                        return
                            getDB("trackerMaxHeight", 600)
                    end,
                    set = function(
                        v)
                ...
                { type = "section", name = "Background" },
                {
                    ...
                    dbKey = "showBackground",
                    get = function()
                        return
                            getDB("showBackground", true)
                    end,
                    set = function(
                        v)
                        setDB("showBackground", v)
                    end
                },
                {
                    type = "slider",
                ...
                },
                {
                    ...
                    dbKey = "classColorGradient",
                    get = function()
                        return
                            getDB("classColorGradient", true)
                    end,
                    set = function(
                        v)
        ...
        },
        {
            ...
            options = {
                { type = "section", name = "Global font" },
                {
                    ...
                    get = function()
                        return
                            getDB("useGlobalFont", true)
                    end,
                    set = function(
                        v)
                        setDB("useGlobalFont", v)
                    end
                },
                {
                    type = "dropdown",
                    ...
                    get = function()
                        return
                            getDB("globalFont", "Friz Quadrata TT")
                    end,
                    set = function(
                        v)
                        setDB("globalFont", v)
                ...
                { type = "section", name = "Header" },
                {
                    ...
                    get = function()
                        return
                            getDB("headerFont", "Friz Quadrata TT")
                    end,
                    set = function(
                        v)
                        setDB("headerFont", v)
                ...
                },
                {
                    ...
                    get = function()
                        return
                            getDB("headerFontSize", 13)
                    end,
                    set = function(
                        v)
                        setDB("headerFontSize", v)
                    end
                },
                {
                    type = "dropdown",
                    ...
                    dbKey = "headerFontOutline",
                    options = OUTLINE_OPTIONS,
                    get = function()
                        return
                            getDB("headerFontOutline", "")
                    end,
                    set = function(
                        v)
                        setDB("headerFontOutline", v)
                    end
                },
                { type = "section", name = "Quest names" },
                {
                    ...
                    get = function()
                        return
                            getDB("questNameFont", "Friz Quadrata TT")
                    end,
                    set = function(
                        v)
                        setDB("questNameFont", v)
                    end
                },
                {
                    type = "slider",
                    ...
                    dbKey = "questNameFontSize",
                    min = 8,
                    max = 24,
                    step = 1,
                    get = function()
                        return
                            getDB("questNameFontSize", 12)
                    end,
                    set = function(
                        v)
                        setDB("questNameFontSize", v)
                    end
                },
                {
                    type = "dropdown",
                    ...
                    dbKey = "questNameFontOutline",
                    options = OUTLINE_OPTIONS,
                    get = function()
                        return
                            getDB("questNameFontOutline", "")
                    end,
                    set = function(
                        v)
                        setDB("questNameFontOutline", v)
                    end
                },
                { type = "section", name = "Objectives" },
                {
                    ...
                    get = function()
                        return
                            getDB("objectiveFont", "Friz Quadrata TT")
                    end,
                    set = function(
                        v)
                        setDB("objectiveFont", v)
                    end
                },
                {
                    type = "slider",
                    ...
                    dbKey = "objectiveFontSize",
                    min = 8,
                    max = 20,
                    step = 1,
                    get = function()
                        return
                            getDB("objectiveFontSize", 11)
                    end,
                    set = function(
                        v)
                        setDB("objectiveFontSize", v)
                    end
                },
                {
                    type = "dropdown",
                    ...
                    dbKey = "objectiveFontOutline",
                    options = OUTLINE_OPTIONS,
                    get = function()
                        return
                            getDB("objectiveFontOutline", "")
                    end,
                    set = function(
                        v)
                        setDB("objectiveFontOutline", v)
                    end
                },
            },
        },
        {
            ...
            options = {
                ...
                { type = "section", name = "Information" },
                {
                    ...
                    dbKey = "showObjectiveNumbers",
                    get = function()
                        return
                            getDB("showObjectiveNumbers", true)
                    end,
                    set = function(
                        v)
                        setDB("showObjectiveNumbers", v)
                    end
                },
                {
                    type = "toggle",
                    ...
                    dbKey = "showQuestLevel",
                    get = function()
                        return
                            getDB("showQuestLevel", false)
                    end,
                    set = function(
                        v)
                        setDB("showQuestLevel", v)
                    end
                },
                {
                    type = "toggle",
                    ...
                    dbKey = "showHeaderCount",
                    get = function()
                        return
                            getDB("showHeaderCount", true)
                    end,
                    set = function(
                        v)
                        setDB("showHeaderCount", v)
                    end
                },
            },
        },
        {
            ...
            name = "Filters",
            options = {
                { type = "section", name = "Zone" },
                {
                    type = "toggle",
                    name = "Current zone only",
                    desc = "Only show quests for your current zone.",
                    dbKey = "filterByCurrentZone",
                    get = function()
                        return
                            getDB("filterByCurrentZone", false)
                    end,
                    set = function(
                        v)
                        setDB("filterByCurrentZone", v)
                    end
                },
                { type = "section", name = "Quest types" },
                {
                    type = "toggle",
                    name = "Show campaign quests",
                    desc = "Display main story campaign quests.",
                    dbKey = "showCampaign",
                    get = function()
                        return
                            getDB("showCampaign", true)
                    end,
                    set = function(
                        v)
                        setDB("showCampaign", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show important quests",
                    desc = "Display quests marked as important.",
                    dbKey = "showImportant",
                    get = function()
                        return
                            getDB("showImportant", true)
                    end,
                    set = function(
                        v)
                        setDB("showImportant", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show legendary quests",
                    desc = "Display legendary quests.",
                    dbKey = "showLegendary",
                    get = function()
                        return
                            getDB("showLegendary", true)
                    end,
                    set = function(
                        v)
                        setDB("showLegendary", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show world quests",
                    desc = "Display world quests and bonus objectives.",
                    dbKey = "showWorldQuests",
                    get = function()
                        return
                            getDB("showWorldQuests", true)
                    end,
                    set = function(
                        v)
                        setDB("showWorldQuests", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show callings",
                    desc = "Display calling/emissary quests.",
                    dbKey = "showCallings",
                    get = function()
                        return
                            getDB("showCallings", true)
                    end,
                    set = function(
                        v)
                        setDB("showCallings", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show daily quests",
                    desc = "Display daily repeatable quests.",
                    dbKey = "showDailies",
                    get = function()
                        return
                            getDB("showDailies", true)
                    end,
                    set = function(
                        v)
                        setDB("showDailies", v)
                ...
                {
                    type = "toggle",
                    name = "Show weekly quests",
                    desc = "Display weekly repeatable quests.",
                    dbKey = "showWeeklies",
                    get = function()
                        return
                            getDB("showWeeklies", true)
                    end,
                    set = function(
                        v)
                        setDB("showWeeklies", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show dungeon/raid",
                    desc = "Display dungeon and raid quests.",
                    dbKey = "showDungeonRaid",
                    get = function()
                        return
                            getDB("showDungeonRaid", true)
                    end,
                    set = function(
                        v)
                        setDB("showDungeonRaid", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show side quests",
                    desc = "Display normal side quests.",
                    dbKey = "showSideQuests",
                    get = function()
                        return
                            getDB("showSideQuests", true)
                    end,
                    set = function(
                        v)
                        setDB("showSideQuests", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show meta quests",
                    desc = "Display meta / wrapper quests.",
                    dbKey = "showMeta",
                    get = function()
                        return
                            getDB("showMeta", true)
                ...
                {
                    type = "toggle",
                    name = "Show PvP quests",
                    desc = "Display PvP-related quests.",
                    dbKey = "showPvP",
                    get = function()
                        return
                            getDB("showPvP", true)
                ...
                {
                    type = "toggle",
                    name = "Show account quests",
                    desc = "Display account-wide quests.",
                    dbKey = "showAccount",
                    get = function()
                        return
                            getDB("showAccount", true)
                    end,
                    set = function(
                        v)
                        setDB("showAccount", v)
        ...
        },
        {
            ...
            options = {
                { type = "section", name = "Interaction" },
                {
                    type = "toggle",
                    name = "Click to focus",
                    desc = "Shift+click a quest to focus it (on-screen arrow/pin).",
                    dbKey = "clickToFocus",
                    get = function()
                        return
                            getDB("clickToFocus", true)
                    end,
                    set = function(
                        v)
                        setDB("clickToFocus", v)
                    end
                },
                {
                    type = "toggle",
                    name = "Show completed quests",
                    desc = "Display completed quests (dimmed) in the tracker.",
                    dbKey = "collapseCompleted",
                    get = function()
                        return
                            getDB("collapseCompleted", true)
                    end,
                    set = function(
                        v)
                ...
                { type = "section", name = "Fading" },
                {
                    ...
                    desc = "Reduce tracker opacity when the mouse is not over it.",
                    dbKey = "fadeWhenNotHovered",
                    get = function()
                        return
                            getDB("fadeWhenNotHovered", false)
                    end,
                    set = function(
                        v)
                        setDB("fadeWhenNotHovered", v)
                    end
                },
                {
                    type = "slider",
...
function TTQ:BuildSettingsUI()
    ...
    panel:SetScript("OnShow", function()
        ...
        if TTQ.ShowPreview then TTQ:ShowPreview() end
    end)

    panel:SetScript("OnHide", function()
        if TTQ.HidePreview then TTQ:HidePreview() end
    end)
end
...
----------------------------------------------------------------------
-- Callback when any setting changes — refresh tracker + preview
----------------------------------------------------------------------
function TTQ:OnSettingChanged(key, value)
    ...
    -- Fade behavior
    if key == "fadeWhenNotHovered" and self.Tracker then
        if value then
            self.Tracker:SetAlpha(self:GetSetting("fadeAlpha"))
        else
            self.Tracker:SetAlpha(1)
        end
    end
...
----------------------------------------------------------------------
-- Live Preview — floating companion panel for style visualization
----------------------------------------------------------------------
function TTQ:CreatePreviewFrame()
    if self.PreviewFrame then return end

    local PREVIEW_WIDTH = 280
    local frame = CreateFrame("Frame", "TTQSettingsPreview", UIParent, "BackdropTemplate")
    frame:SetSize(PREVIEW_WIDTH, 240)
    ...
    -- Preview title bar
    local prevTitleBar = CreateFrame("Frame", nil, frame)
    prevTitleBar:SetHeight(24)
    prevTitleBar:SetPoint("TOPLEFT", frame, "TOPLEFT", 0, 0)
    prevTitleBar:SetPoint("TOPRIGHT", frame, "TOPRIGHT", 0, 0)

    local prevTitleText = self:CreateText(prevTitleBar, 11, { r = 0.7, g = 0.7, b = 0.7 }, "CENTER")
    prevTitleText:SetPoint("CENTER", prevTitleBar, "CENTER", 0, 0)
    prevTitleText:SetText("Live Preview  (drag to move)")
    frame.titleText = prevTitleText

    local titleSep = prevTitleBar:CreateTexture(nil, "ARTWORK")
    titleSep:SetHeight(1)
    titleSep:SetPoint("BOTTOMLEFT", prevTitleBar, "BOTTOMLEFT", 8, 0)
    titleSep:SetPoint("BOTTOMRIGHT", prevTitleBar, "BOTTOMRIGHT", -8, 0)
    titleSep:SetColorTexture(1, 1, 1, 0.12)

    -- Content area for mock tracker
    local content = CreateFrame("Frame", nil, frame)
    content:SetPoint("TOPLEFT", prevTitleBar, "BOTTOMLEFT", 12, -6)
    content:SetPoint("TOPRIGHT", prevTitleBar, "BOTTOMRIGHT", -12, -6)
    content:SetHeight(200)
    frame.content = content

    -- === Group header ===
    local headerIcon = content:CreateTexture(nil, "ARTWORK")
    headerIcon:SetSize(12, 12)
    pcall(headerIcon.SetAtlas, headerIcon, "Campaign-QuestLog-LoreBook", false)
    frame.headerIcon = headerIcon

    local headerText = self:CreateText(content, 13, { r = 1, g = 0.82, b = 0 }, "LEFT")
    headerText:SetText("Campaign")
    frame.headerText = headerText

    local headerCount = self:CreateText(content, 11, { r = 0.6, g = 0.6, b = 0.6 }, "RIGHT")
    headerCount:SetText("2")
    frame.headerCount = headerCount
    ...
    local q1Icon = content:CreateTexture(nil, "ARTWORK")
    q1Icon:SetSize(14, 14)
    pcall(q1Icon.SetAtlas, q1Icon, "Campaign-QuestLog-LoreBook", false)
    frame.q1Icon = q1Icon

    local q1Name = self:CreateText(content, 12, { r = 0.95, g = 0.95, b = 0.95 }, "LEFT")
    q1Name:SetText("The Dragon's Legacy")
    frame.q1Name = q1Name

    -- Obj 1: incomplete with progress
    local o1Dash = self:CreateText(content, 11, { r = 0.85, g = 0.85, b = 0.85 }, "LEFT")
    o1Dash:SetText("-")
    o1Dash:SetWidth(10)
    frame.o1Dash = o1Dash

    local o1Text = self:CreateText(content, 11, { r = 0.85, g = 0.85, b = 0.85 }, "LEFT")
    o1Text:SetText("Speak with Alexstrasza (3/5)")
    frame.o1Text = o1Text
    ...
    local o2Text = self:CreateText(content, 11, { r = 0.5, g = 0.5, b = 0.5 }, "LEFT")
    o2Text:SetText("Collect Dragon Scales (8/8)")
    frame.o2Text = o2Text

    -- === Quest 2: focused ===
    local stBar = content:CreateTexture(nil, "OVERLAY")
    stBar:SetWidth(2)
    stBar:SetColorTexture(0.4, 0.8, 1, 1)
    frame.stBar = stBar

    local q2Icon = content:CreateTexture(nil, "ARTWORK")
    q2Icon:SetSize(14, 14)
    pcall(q2Icon.SetAtlas, q2Icon, "quest-important-turnin", false)
    frame.q2Icon = q2Icon

    local q2Name = self:CreateText(content, 12, { r = 0.4, g = 0.8, b = 1.0 }, "LEFT")
    q2Name:SetText("The Siege of Valdrakken")
    frame.q2Name = q2Name

    -- Obj 3: incomplete with progress
    local o3Dash = self:CreateText(content, 11, { r = 0.85, g = 0.85, b = 0.85 }, "LEFT")
    o3Dash:SetText("-")
    o3Dash:SetWidth(10)
    frame.o3Dash = o3Dash

    local o3Text = self:CreateText(content, 11, { r = 0.85, g = 0.85, b = 0.85 }, "LEFT")
    o3Text:SetText("Defend the plaza (1/3)")
    frame.o3Text = o3Text
...
----------------------------------------------------------------------
-- Refresh / re-layout the live preview with current settings
----------------------------------------------------------------------
function TTQ:RefreshPreview()
    local frame = self.PreviewFrame
    if not frame or not frame:IsShown() then return end

    local content = frame.content
    local cw = content:GetWidth()
    if cw < 1 then cw = 256 end

    -- Read current settings
    local headerFont = self:GetResolvedFont("header")
    local headerSize = self:GetSetting("headerFontSize")
    local headerOutline = self:GetSetting("headerFontOutline") or ""
    local headerColor = self:GetSetting("headerColor")

    local questFont = self:GetResolvedFont("quest")
    local questSize = self:GetSetting("questNameFontSize")
    local questOutline = self:GetSetting("questNameFontOutline") or ""
    local questColor = self:GetSetting("questNameColor")

    local objFont = self:GetResolvedFont("objective")
    local objSize = self:GetSetting("objectiveFontSize")
    local objOutline = self:GetSetting("objectiveFontOutline") or ""
    local incColor = self:GetSetting("objectiveIncompleteColor")
    local compColor = self:GetSetting("objectiveCompleteColor")
    local stColor = self:GetSetting("focusColor") or self:GetSetting("superTrackedColor") or { r = 1, g = 0.82, b = 0 }

    local showIcons = self:GetSetting("showIcons")
    local showNums = self:GetSetting("showObjectiveNumbers")
    local showCount = self:GetSetting("showHeaderCount")

    local indent = showIcons and 19 or 0
    local objIndent = indent + 4

    -- Helper: safely set font
    local function safeFont(fs, face, sz, outline)
        if not pcall(fs.SetFont, fs, face, sz, outline) then
            pcall(fs.SetFont, fs, "Fonts\\FRIZQT__.TTF", sz, outline)
        end
    end

    -- ---- Layout (dynamic y position) ----
    local y = 0

    -- Group header
    frame.headerIcon:ClearAllPoints()
    frame.headerIcon:SetPoint("TOPLEFT", content, "TOPLEFT", 0, -y)
    frame.headerIcon:SetShown(showIcons)

    safeFont(frame.headerText, headerFont, headerSize, headerOutline)
    frame.headerText:SetTextColor(headerColor.r, headerColor.g, headerColor.b)
    frame.headerText:ClearAllPoints()
    if showIcons then
        frame.headerText:SetPoint("LEFT", frame.headerIcon, "RIGHT", 5, 0)
    else
        frame.headerText:SetPoint("TOPLEFT", content, "TOPLEFT", 0, -y)
    end
    frame.headerText:SetText(showCount and "Campaign (2)" or "Campaign")

    safeFont(frame.headerCount, headerFont, headerSize - 2, headerOutline)
    frame.headerCount:ClearAllPoints()
    frame.headerCount:SetPoint("RIGHT", content, "RIGHT", 0, -y - headerSize / 2)
    frame.headerCount:SetShown(showCount)

    y = y + headerSize + 6

    frame.headerSep:ClearAllPoints()
    frame.headerSep:SetPoint("TOPLEFT", content, "TOPLEFT", 0, -y)
    frame.headerSep:SetPoint("RIGHT", content, "RIGHT", 0, 0)
    y = y + 4

    -- Quest 1
    frame.q1Icon:ClearAllPoints()
    frame.q1Icon:SetPoint("TOPLEFT", content, "TOPLEFT", 4, -y)
    frame.q1Icon:SetShown(showIcons)

    safeFont(frame.q1Name, questFont, questSize, questOutline)
    frame.q1Name:SetTextColor(questColor.r, questColor.g, questColor.b)
    frame.q1Name:ClearAllPoints()
    frame.q1Name:SetPoint("TOPLEFT", content, "TOPLEFT", indent + 4, -y)
    frame.q1Name:SetPoint("RIGHT", content, "RIGHT", -4, 0)
    y = y + questSize + 6

    -- Obj 1
    frame.o1Dash:ClearAllPoints()
    frame.o1Dash:SetPoint("TOPLEFT", content, "TOPLEFT", objIndent, -y)
    safeFont(frame.o1Dash, objFont, objSize, objOutline)
    frame.o1Dash:SetTextColor(incColor.r, incColor.g, incColor.b)
    frame.o1Dash:SetText("-")

    frame.o1Text:ClearAllPoints()
    frame.o1Text:SetPoint("LEFT", frame.o1Dash, "RIGHT", 2, 0)
    frame.o1Text:SetPoint("RIGHT", content, "RIGHT", 0, 0)
    safeFont(frame.o1Text, objFont, objSize, objOutline)
    frame.o1Text:SetTextColor(incColor.r, incColor.g, incColor.b)
    frame.o1Text:SetText(showNums and "Speak with Alexstrasza (3/5)" or "Speak with Alexstrasza")
    y = y + objSize + 6

    -- Obj 2 (complete)
    frame.o2Dash:ClearAllPoints()
    frame.o2Dash:SetPoint("TOPLEFT", content, "TOPLEFT", objIndent, -y)
    ...
    frame.o2Text:SetPoint("RIGHT", content, "RIGHT", 0, 0)
    safeFont(frame.o2Text, objFont, objSize, objOutline)
    frame.o2Text:SetTextColor(compColor.r, compColor.g, compColor.b)
    frame.o2Text:SetText(showNums and "Collect Dragon Scales (8/8)" or "Collect Dragon Scales")
    y = y + objSize + 6

    -- Quest 2 (focused)
    frame.q2Icon:ClearAllPoints()
    frame.q2Icon:SetPoint("TOPLEFT", content, "TOPLEFT", 4, -y)
    frame.q2Icon:SetShown(showIcons)

    safeFont(frame.q2Name, questFont, questSize, questOutline)
    frame.q2Name:SetTextColor(stColor.r, stColor.g, stColor.b)
    frame.q2Name:ClearAllPoints()
    frame.q2Name:SetPoint("TOPLEFT", content, "TOPLEFT", indent + 4, -y)
    frame.q2Name:SetPoint("RIGHT", content, "RIGHT", -4, 0)

    frame.stBar:ClearAllPoints()
    frame.stBar:SetPoint("TOPLEFT", content, "TOPLEFT", 0, -y + 1)
    frame.stBar:SetPoint("BOTTOMLEFT", content, "TOPLEFT", 0, -(y + questSize + 4))
    frame.stBar:SetColorTexture(stColor.r, stColor.g, stColor.b, 1)
    y = y + questSize + 6

    -- Obj 3
    frame.o3Dash:ClearAllPoints()
    frame.o3Dash:SetPoint("TOPLEFT", content, "TOPLEFT", objIndent, -y)
    safeFont(frame.o3Dash, objFont, objSize, objOutline)
    frame.o3Dash:SetTextColor(incColor.r, incColor.g, incColor.b)
    frame.o3Dash:SetText("-")

    frame.o3Text:ClearAllPoints()
    frame.o3Text:SetPoint("LEFT", frame.o3Dash, "RIGHT", 2, 0)
    frame.o3Text:SetPoint("RIGHT", content, "RIGHT", 0, 0)
    safeFont(frame.o3Text, objFont, objSize, objOutline)
    frame.o3Text:SetTextColor(incColor.r, incColor.g, incColor.b)
    frame.o3Text:SetText(showNums and "Defend the plaza (1/3)" or "Defend the plaza")
    y = y + objSize + 8
    content:SetHeight(y)
    frame:SetHeight(24 + 6 + y + 8)
end

----------------------------------------------------------------------
-- Show / hide the preview alongside the options panel
----------------------------------------------------------------------
function TTQ:ShowPreview()
    self:CreatePreviewFrame()

    self.PreviewFrame:ClearAllPoints()
    local panel = self.OptionsPanel
    if panel and panel:IsShown() then
        self.PreviewFrame:SetPoint("TOPRIGHT", panel, "TOPLEFT", -10, -20)
    else
        self.PreviewFrame:SetPoint("CENTER", UIParent, "CENTER", -400, 80)
    end
